  ...
  return (
    <section className="hero" id="home">
      ...
      <div
        ...
        style={{ maxWidth: "1280px", zIndex: 2 }}
      >
        <div className="hero-content">
          ...
          {/* Stats — Bootstrap row + col grid */}
          <div
            className="row row-cols-2 row-cols-md-4 g-2 hero-stats"
            ref={statsRef}
          >
            {STATS.map((s) => (
      ...
      {/* Scroll Indicator */}
      <div className="scroll-indicator d-flex flex-column align-items-center gap-2">
